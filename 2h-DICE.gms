...
** Population and technology
        ...
        qmin     Minimal proportion of producers                   /0.01    /
        qmax     Maximum proportion of producers                   /0.99    /
        q        Proportion of producers (multiply L by this number) 
...
* Further definitions of parameters
        ...
        l1("1") = pop0;
        loop(t, l1(t+1)=l1(t););
        loop(t, l1(t+1)=l1(t)*(popasym/L1(t))**popadj ;);
...
*        TRANSFER(t)     Intra transfer
        ...
        UTILITYW        Welfare function Worker
        UTILITYP        Welfare function Capitalist
;
...
*        PERIODUEQ(t)     Instantaneous utility function equation
        ...
        UTILW             Objective function worker
        UTILP             Objective function capitalist
        JJJ
*CONSEQ(t)
;
...
* rieq(t+1)..          RI(t)          =E= (1+prstp) * (CPC(t+1)/CPC(t))**(elasmu/tstep) - 1;
 rieq(t)..          RI(t)          =E= GAMA *(1-damfrac(t))* al(t)*((P(t)+L(t))/1000/K(t))**(1-GAMA) - dk;
...
* cemutotpereq(t)..    CEMUTOTPER(t)  =E= (PERIODU_W(t) * L(t) + PERIODU_P(t) * P(t)) * rr(t);
 ...
 cemutotpereqP(t)..    CEMUTOTPERP(t)  =E= PERIODU_P(t) * rr(t);
 cemutotpereqW(t)..    CEMUTOTPERW(t)  =E= PERIODU_W(t) * rr(t);
 utilP..               UTILITYP        =E= tstep * sum(t,  CEMUTOTPERP(t));
...
file results3 /SPOM_S.csv/;     results3.nd = 10 ; results3.nw = 0 ; results3.pw=1200000; results3.pc=5;
file res6 /SPOM_TATM.csv/;     res6.nd = 10 ; res6.nw = 0 ; res6.pw=1200000; res6.pc=5;
file res8 /SPOM_CPCP.csv/;     res8.nd = 10 ; res8.nw = 0 ; res8.pw=1200000; res8.pc=5;
file res81 /SPOM_CPCW.csv/;     res81.nd = 10 ; res81.nw = 0 ; res81.pw=1200000; res81.pc=5;
file res12 /SPOM_ABATECOSTtoGDP.csv/;     res12.nd = 10 ; res12.nw = 0 ; res12.pw=1200000; res12.pc=5;
file res15 /SPOM_YNET.csv/;     res15.nd = 10 ; res15.nw = 0 ; res15.pw=1200000; res15.pc=5;


loop(N,
q = qmin+(qmax-qmin)*(N.val-1)/(card(N)-1);
loop(t, p(t)=l1(t)*q;);
loop(t, l(t)=l1(t)*(1-q););
...
option decimals=4;
display utility.l,betta.l,utilityW.l,utilityP.l;
