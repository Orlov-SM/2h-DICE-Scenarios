...
set        t  Time periods (5 years per period)                    /1*60/ 
          N        Number of different transfers                /1*50/;
...
cpc1(t)$tlate(t)..           TRANSFER(t)        =E= -tau_P*(1-q)*YNET(t) * (1-GAMA);
cpc2(t)$tearly(t)..          TRANSFER(t)        =E= -tau_P*(1-q)*YNET(t) * (1-GAMA);
...
file results3 /COOMT_S.csv/;     results3.nd = 10 ; results3.nw = 0 ; results3.pw=1200000; results3.pc=5;
file res6 /COOMT_TATM.csv/;     res6.nd = 10 ; res6.nw = 0 ; res6.pw=1200000; res6.pc=5;
file res12 /COOMT_ABATECOSTtoGDP.csv/;     res12.nd = 10 ; res12.nw = 0 ; res12.pw=1200000; res12.pc=5;
file res15 /COOMT_YNET.csv/;     res15.nd = 10 ; res15.nw = 0 ; res15.pw=1200000; res15.pc=5;
file res8 /COOMT_CPCP.csv/;     res8.nd = 10 ; res8.nw = 0 ; res8.pw=1200000; res8.pc=5;
file res81 /COOMT_CPCW.csv/;     res81.nd = 10 ; res81.nw = 0 ; res81.pw=1200000; res81.pc=5;


loop(N,
tau_P = (N.val-1)/(card(N)-1);
