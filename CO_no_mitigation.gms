...
** Population and technology
        ...
        const    weight in integral for producers (95 best fit)   /1     /
...
* rieq(t+1)..          RI(t)          =E= (1+prstp) * (CPC(t+1)/CPC(t))**(elasmu/tstep) - 1;
 rieq(t+1)..          RI(t)          =E= GAMA *(1-damfrac(t))* al(t)*((L(t)+P(t))/1000/K(t))**(1-GAMA) - dk;
...
file results3 /CONM_S.csv/;     results3.nd = 10 ; results3.nw = 0 ; results3.pw=1200000; results3.pc=5;
file res6 /CONM_TATM.csv/;     res6.nd = 10 ; res6.nw = 0 ; res6.pw=1200000; res6.pc=5;
file res8 /CONM_CPCP.csv/;     res8.nd = 10 ; res8.nw = 0 ; res8.pw=1200000; res8.pc=5;
file res81 /CONM_CPCW.csv/;     res81.nd = 10 ; res81.nw = 0 ; res81.pw=1200000; res81.pc=5;
file res12 /CONM_ABATECOSTtoGDP.csv/;     res12.nd = 10 ; res12.nw = 0 ; res12.pw=1200000; res12.pc=5;
file res15 /CONM_YNET.csv/;     res15.nd = 10 ; res15.nw = 0 ; res15.pw=1200000; res15.pc=5;
...
option decimals=4;
display utility.l;
*Execute_Unload 'consumption.gdx',C_W;
