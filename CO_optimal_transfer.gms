...
** Population and technology
        ...
        const    weight in integral for producers(18 the best)      /1     /
...
** Climate damage parameters
        ...
        a2base    Initial damage quadratic term  (2023)            /0.003467/
...
* Program control definitions
        ...
        tearly(t) = yes$(t.val <= 30);
        tlate(t)  = yes$(t.val > 30);
...
*        B(t)            Bonds
        betta(t)         Share of Abatament subtracted from Workers consumption
...
*        PERIODU(t)      One period utility function
        ...
        CEMUTOTPERW(t)   Period utility
        J(t)            Welfare function of time
        TRANSFER(t)     Intra transfer
        UTILITY         Welfare function
        UTILITYW         Welfare function
        tau_W(t)           Tax on workers
        tau_P           Tax on producers
;
...
* Utility
        ...
        CEMUTOTPEREQW(t)  Period utility
...
* damfraceq(t) ..      DAMFRAC(t)     =E=  1- 1/(1 + (TATM(t)/20.46)**2 + (TATM(t)/6.081)**6.754);
...
* taxeq(t)..           TAXCOST(t)     =E= YNET(t) * tau(t) * (1-GAMA);
 ...
 cw(t)..              C_W(t)         =E= (1-q)*YNET(t) * (1-GAMA)- betta(t)*ABATECOST(t) +TRANSFER(t);
 cp(t)..              C_P(t)         =E= YNET(t) - I(t) - C_W(t) - ABATECOST(t);
* cpc1(t)$tlate(t)..           TRANSFER(t)        =E= 0;
* cpc2(t)$tearly(t)..           TRANSFER(t)        =E= 0;
* cpc1(t)$tlate(t)..           TRANSFER(t)        =E= 0.3*(t.val-31)/30*GAMA*YNET(t)+0.3*(t.val-31)/30*q*YNET(t) * (1-GAMA);
* cpc2(t)$tearly(t)..           TRANSFER(t)        =E= -0.1*(31-t.val)/30*(1-q)*YNET(t) * (1-GAMA);
* cpc1(t)$tlate(t)..           TRANSFER(t)        =E= tau_P*GAMA*YNET(t)+tau_P*q*YNET(t) * (1-GAMA);
* cpc2(t)$tearly(t)..           TRANSFER(t)        =E= -tau_W*(1-q)*YNET(t) * (1-GAMA);
* cpc1(t)$tlate(t)..           TRANSFER(t)        =E= 0*GAMA*YNET(t)+0*q*YNET(t) * (1-GAMA);
* cpc2(t)$tearly(t)..           TRANSFER(t)        =E= -0.7*(1-q)*YNET(t) * (1-GAMA);
cpc1(t)$tlate(t)..           TRANSFER(t)        =E= -tau_W(t)*(1-q)*YNET(t) * (1-GAMA);
cpc2(t)$tearly(t)..           TRANSFER(t)        =E= -tau_W(t)*(1-q)*YNET(t) * (1-GAMA);
...
* cemutotpereq(t)..    CEMUTOTPER(t)  =E= (PERIODU_W(t) * L(t) + const*PERIODU_P(t) * P(t)) * rr(t);
 ...
 cemutotpereqW(t)..    CEMUTOTPERW(t)  =E= PERIODU_W(t) * rr(t);
...
* periodupeq(t)..       PERIODU_P(t)  =E= (C_P(T)**(1-elasmu)-1)/(1-elasmu)-1;
* perioduweq(t)..       PERIODU_W(t)  =E= log(CPC_W(T));
* periodupeq(t)..       PERIODU_P(t)  =E= log(CPC_P(T));
 util..               UTILITY        =E= tstep * sum(t,  CEMUTOTPER(t));
 utilW..               UTILITYW        =E= tstep * sum(t,  CEMUTOTPERW(t));
 utilwcons..        UTILITYW        =G= 36.3877;
...
option decimals=4;
display utility.l,utilityw.l,tau_W.l,tau_P.l;
...
file results1 /PM_K.csv/;     results1.nd = 10 ; results1.nw = 0 ; results1.pw=1200000; results1.pc=5;
put results1;
Loop (t, put K.l(t));
putclose;

file results2 /PM_MAT.csv/;     results2.nd = 10 ; results2.nw = 0 ; results2.pw=1200000; results2.pc=5;
put results2;
Loop (t, put MAT.l(t));
putclose;

file results3 /PM_S.csv/;     results3.nd = 10 ; results3.nw = 0 ; results3.pw=1200000; results3.pc=5;
put results3;
Loop (t, put S.l(t));
putclose;

file results4 /PM_CP.csv/;     results4.nd = 10 ; results4.nw = 0 ; results4.pw=1200000; results4.pc=5;
put results4;
Loop (t, put C_P.l(t));
putclose;

file results41 /PM_CW.csv/;     results41.nd = 10 ; results41.nw = 0 ; results41.pw=1200000; results41.pc=5;
put results41;
Loop (t, put C_W.l(t));
putclose;

file res5 /PM_DAMFRAC.csv/;     res5.nd = 10 ; res5.nw = 0 ; res5.pw=1200000; res5.pc=5;
put res5;
Loop (t, put DAMFRAC.l(t));
putclose;

file res6 /PM_TATM.csv/;     res6.nd = 10 ; res6.nw = 0 ; res6.pw=1200000; res6.pc=5;
put res6;
Loop (t, put TATM.l(t));
putclose;

file res7 /PM_MIU.csv/;     res7.nd = 10 ; res7.nw = 0 ; res7.pw=1200000; res7.pc=5;
put res7;
Loop (t, put MIU.l(t));
putclose;

file res8 /PM_CPCP.csv/;     res8.nd = 10 ; res8.nw = 0 ; res8.pw=1200000; res8.pc=5;
put res8;
Loop (t, put CPC_P.l(t));
putclose;

file res81 /PM_CPCW.csv/;     res81.nd = 10 ; res81.nw = 0 ; res81.pw=1200000; res81.pc=5;
put res81;
Loop (t, put CPC_W.l(t));
putclose;

file res9 /PM_RI.csv/;     res9.nd = 10 ; res9.nw = 0 ; res9.pw=1200000; res9.pc=5;
put res9;
Loop (t, put RI.l(t));
putclose;

file res10 /PM_L.csv/;     res10.nd = 10 ; res10.nw = 0 ; res10.pw=1200000; res10.pc=5;
put res10;
Loop (t, put L(t));
putclose;

file res11 /PM_P.csv/;     res11.nd = 10 ; res11.nw = 0 ; res11.pw=1200000; res11.pc=5;
put res11;
Loop (t, put P(t));
putclose;

file res12 /PM_ABATECOST.csv/;     res12.nd = 10 ; res12.nw = 0 ; res12.pw=1200000; res12.pc=5;
put res12;
Loop (t, put ABATECOST.l(t));
putclose;


file res13 /PM_I.csv/;     res13.nd = 10 ; res13.nw = 0 ; res13.pw=1200000; res13.pc=5;
put res13;
Loop (t, put I.l(t));
putclose;


file res15 /PM_YNET.csv/;     res15.nd = 10 ; res15.nw = 0 ; res15.pw=1200000; res15.pc=5;
put res15;
Loop (t, put YNET.l(t));
putclose;

file res16 /PM_TRANSFER.csv/;     res16.nd = 10 ; res16.nw = 0 ; res16.pw=1200000; res16.pc=5;
put res16;
Loop (t, put TRANSFER.l(t));
putclose;


file res17 /PM_betta.csv/;     res17.nd = 10 ; res17.nw = 0 ; res17.pw=1200000; res17.pc=5;
put res17;
Loop (t, put betta.l(t));
putclose;